...
```text
CF 项目 A ──┐
CF 项目 B ──┼── https://intent.hzdv.net/v1 （推荐 Tunnel）或 http://ocr.hzdv.net:8090/v1
...
**加固**：见 [`../tunnel/README.md`](../tunnel/README.md)（Cloudflare Tunnel + `INTENT_SERVICE_URL=https://intent.hzdv.net/v1`）。
...
| 变量 | 值 |
|------|----|
| `INTENT_SERVICE_URL` | `https://intent.hzdv.net/v1`（Tunnel；旧：`http://ocr.hzdv.net:8090/v1`） |
