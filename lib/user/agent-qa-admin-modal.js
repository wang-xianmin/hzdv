...
(function () {
  ...
  function ensureUi() {
    ...
    overlay.querySelector("#agentQaAdminHint").textContent = t(
      "仅企业相关问答。人工改类别/标准答/绑定条目后点「发布回灌」才会写入向量库；未纠错不回灌。权鉴与网站背景、产品目录相同。",
      "Enterprise Q&A only. Publish to vectors only after human correction. Same access as Site Background / Product Catalog."
    );
    overlay
