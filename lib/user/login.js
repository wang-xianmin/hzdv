...
(function () {
    ...
    var topNavAvatarManage = document.getElementById('topNavAvatarManage');
            ...
            function openTurnstileOverlay(siteKey, cfg, onVerified, skipVerifyEndpoint, onCancel) {
                if (!turnstileOverlay || !turnstileWidgetMount) return;
                turnstileOnCancel = typeof onCancel === 'function' ? onCancel : null;
            ...
            if (turnstileCancelBtn && turnstileOverlay) {
                ...
                turnstileOverlay.addEventListener('click', function (e) {
                    if (e.target === turnstileOverlay) closeTurnstileOverlay(true);
                });
            }
            ...
            function requireTurnstileThen(onPass, onCancel) {
            ...
            if (registerSubmitBtn) {
                registerSubmitBtn.addEventListener('click', function () {
                    ...
                    hideNewUserKvPreview();
                    setRegisterLoginStatus('pwd', '请完成人机验证…', 'pending');
                    requireTurnstileThen(function () {
                    ...
                    try {
                        ...
                        if (
                            ...
                            requireTurnstileThen(
                                ...
                                function onCancelTurnstileAfterEmail() {
                                    alert(
                                        tScan(
                                            '已取消人机验证，登录未成功。',
                                            'Human check cancelled. Sign-in was not completed.'
                                        )
                                    );
                                    closeRegister();
                                }
