(function () {
  ...
  var html =
    ...
    '<div class="register-input-line register-input-line--stack register-input-line--compact">' +
    ...
    "</div>" +
    '<p class="register-qr-hint register-qr-hint--inline" id="registerQrHint">请填写手机号和邮箱，用手机相机扫描二维码；手机上完成人机验证后，查收邮箱并点击「确认登录」</p>' +
