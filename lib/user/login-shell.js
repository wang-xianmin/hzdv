(function () {
  ...
  var html =
    ...
    '<img id="cameraQrImg" alt="登录二维码" width="100" height="100" />' +
    "</div>" +
    '<p class="register-qr-hint register-qr-hint--inline" id="registerQrHint">请填写手机号和邮箱，用手机相机扫描二维码；随后查收邮箱并点击「确认登录」</p>' +
