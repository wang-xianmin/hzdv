...
(function () {
    ...
    function injectProfileHTML() {
        ...
        '                    spellcheck="false"\n' +
        '                    aria-readonly="true"\n' +
        '                    aria-label="原密码（不可修改，仅展示当前收据中的口令）"\n' +
    ...
    function initProfile() {
        ...
        function openProfileModal() {
            ...
            profileOriginalPassword = normalizeStoredPlainPasswordForProfile(
                v && v.pwd != null ? String(v.pwd) : ''
            );
            if (profilePasswordInput) profilePasswordInput.value = profileOriginalPassword;
